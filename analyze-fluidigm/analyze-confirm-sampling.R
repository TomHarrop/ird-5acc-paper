...
chip3 <- read_fluidigm("../data-raw/fluidigm_ok/fludigm_validate_sample_chip3.xlsx")
chip4 <- read_fluidigm("../data-raw/fluidigm_ok/fludigm_validate_sample_chip4.xlsx")
