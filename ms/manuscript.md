...
Rice has a varied domestication history that involves two clades that were domesticated independently in two separated continents: Asia and Africa. Asian and African rice split around two millions years ago [@zhu2005phylogenetic]. The domesticated Asian rice *O. Sativa* appeared 10000 years ago and went through a convoluted domestication history that involves a network of subspecies, most importantly *indica* and *sativa* and frequent introgressions of its wild relative *O. rufipogon*. Instead, the african rice *O. glaberrima* has simpler history: it was domesticated only 3000 years ago and doesn't show signs of introgressions from its wild relative *O. barthii* [Reviewed by @vaughan2008evolving]. ***some newer review?***

In both rice clades, domesticated species tend to produce panicles that are more complex and ramified. The rice panicle is made by a rachis, by branches of primary to tertiary order and by the reproductive spikelets. The rachis produces only branches, primary and secondary branches, instead. produces axillary meristems that can differentiate into higher order branches or spikelets. Domesticated species tend to produce more primary and secondary branches, more axillary meristems and eventually more spikelets. But the number and ratio of branches and spikelets and their topology on the panicle of wild and domesticated varieties of different rice species and clades wasn't yet described systematically.

The architecture and topology of panicle branches are shaped by genes that determine the size, activity, rate of maturation and identity of reproductive meristems. The main known branch gene is *TAWAWA1*, a transcription factor  that keeps the apical meristem indeterminate [@yoshida2013tawawa1]. The genes *LAX Panicles 1*, *LAX Panicles 2* [@komatsu2001lax1, @tabuchi2011lax], instead, control the formation of axillary meristem and therefore they are also involved in branching. Moreover *Aberrant Panicle Organization 1* and *Aberrant Panicle organization 2* controls meristem's transitions, and when those genes are missing meristems progress to spikelet meristem prematurely and branching is reduced [@ikeda2012aberrant]. ***this paragraph can be extended based our focus in the manuscript.***

Although the genetics of panicle development has been partly characterized, we identified two aspects that can be further characterized:

- Many more genes could to determine panicle architectures, but they are yet to be identified ***mention Harrop 2016 here?***

- Which genetic changes determined the changes of panicle architecture during speciation and domestication?

The the genetic of panicle development is reviewed as part of shoot development by [@wang2018genetic]. though the genetic of panicle development is only partially known.
...
We have searched DNA motives in the promoters of 100 genes upregulated in the Branch Meristem and viceversa.

We have selected those genes using the PC5 and we have scanned the promoters using MEME.

In the genes upregulated in the
